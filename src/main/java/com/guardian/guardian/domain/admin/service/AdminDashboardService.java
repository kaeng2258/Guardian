package com.guardian.guardian.domain.admin.service;
...
import com.guardian.guardian.domain.notification.repository.NotificationRepository;
...
public class AdminDashboardService {
    ...
    public Map<String, Object> getOverview() {
        ...
        result.put("recentAlerts", emergencyAlertRepository.findByStatus(
                com.guardian.guardian.domain.emergency.EmergencyAlertStatus.PENDING));
