package com.guardian.guardian.domain.video.service;
...
import com.guardian.guardian.domain.video.entity.VideoSession;
import com.guardian.guardian.domain.video.repository.VideoSessionRepository;
...
public class VideoSessionService {
    ...
    public VideoSessionResponse create(VideoSessionRequest request) {
        ...
        VideoSession session = VideoSession.builder()
                ...
                .status(com.guardian.guardian.domain.video.VideoSessionStatus.REQUESTED)
